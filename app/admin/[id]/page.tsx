  ...
  return (
    <main className="min-h-screen bg-night">
      <div className="mx-auto flex max-w-lg flex-col gap-4 px-4 py-5">
        ...
        {/* ── VoiceX — تحكّم لكل مشترك ──
            السوبر-أدمن (المالك): على أي حساب حتى حسابه. الأدمن العادي: على المناديب
            بس (مش على أدمن/سوبر) — بطلب المالك عشان الأدمنز يقدروا يفتحوا/يقفلوا
            الصوت وباقي الصفحات للناس. زر VoiceX افتراضي مقفول؛ القفل يرجّع لديبجرام.
            زر باقي الصفحات افتراضي مفتوح؛ قفله + فتح VoiceX = «صفحة صوت VoiceX فقط».
            (الباك-إند بيمنع الأدمن العادي من حسابات الأدمن/السوبر برضه، حماية مزدوجة.) */}
        {(isSuper || (p.role === "agent" && !p.is_super)) && (() => {
