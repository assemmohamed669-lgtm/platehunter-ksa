...
export const PREFERRED_COLS = [
  ...
  "التاريخ", "تاريخ",
  // Bank / entity — البنك المالك للسيارة المطلوبة. المستخدم طلبه يظهر في نتيجة
  // الفرز (بيجمّع محافظ من بنوك مختلفة فمهم يعرف كل سيارة تبع أنهي بنك). بالعربي
  // بس — «Agency» الإنجليزي بيفضل مستبعَد (اختبار قائم). المطابقة بالاحتواء
  // بتغطّي «البنك»/«اسم البنك»/«بنك التمويل».
  "البنك", "بنك",
  // Notes — ملاحظات الداتا الميدانية. بطلب المالك تظهر تلقائياً في نتيجة الفرز
  // بدون ما المندوب يحددها. (تفضل مخفية في نتيجة السجلات عبر isHiddenTashyeekCol.)
  // «ملاحظة» بتتطبّع لـ«ملاحظه» في المطابقة، فبنضيف الصيغتين. «ملاحظات» بتغطّي
  // «الملاحظات»/«ملاحظاتي» بالاحتواء.
  "ملاحظات", "ملاحظه",
];
