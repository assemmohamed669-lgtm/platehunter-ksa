...
// ─── Phonetic merges ── اتّنقلت لـ dictionaries/mergedWords.ts (IDENTICAL) ───

// ─── Spoken numbers ── اتّنقلت لـ dictionaries/numbers.ts (IDENTICAL) ───
// المدخلات المركّبة (10-19) لازم تيجي الأول قبل مفرداتها؛ الترتيب الأطول-أولاً
// في القاموس بيضمن ده تلقائياً.
